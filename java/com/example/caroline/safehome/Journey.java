...
public class Journey extends FragmentActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new GetEmergencyDetails().execute("http://147.252.138.19:8080/restEmergency");
        try {
            Thread.sleep(1000);
        } catch (InterruptedException e) {
            e.printStackTrace();
        }
        new GetUsers().execute("http://147.252.138.19:8080/restusers");
        try{
            Thread.sleep(1000);
        }catch( InterruptedException e){
            e.printStackTrace();
        ...
        {// Use default InfoWindow frame
            ...
            public View getInfoContents(Marker arg0) {
                ...
                TextView speed = (TextView) v.findViewById(R.id.time);
...
//
            ...
            //  tvDistanceDuration.setText("Distance:" + distance + ", Arrival Time:" + time1);
            ...
            String message = "Destination" + loc1 + ""  + "Distance" + distance + "" + "Current Location" + "" + getMyLocationAddress(latLng.latitude, latLng.longitude);
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    if(f!=null) {
                        ...
                        for (int j = 0; j < f.length(); j++) {
                            ...
                            String n = f.getJSONObject(j).getString("phoneNumber");
                            f2.setPhoneNumber(n);
                            followers.add(f2);
    ...
    private class MyDownloadTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String url = "http://147.252.138.19:8080/create_notification";
            String result = "fail";
