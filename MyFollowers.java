        ...
        mDrawerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position==0){
                    ...
                    Intent i = new Intent(MyFollowers.this , Journey.class);
                    startActivity(i);
                } else if (position == 3) {
                    Intent i = new Intent(MyFollowers.this, MyFollowers.class);
                    startActivity(i);
                } else if (position == 4) {
                    Intent i = new Intent(MyFollowers.this, AddFollowers.class);
                    startActivity(i);
                } else if (position == 5) {
                    Intent i = new Intent(MyFollowers.this, ViewNotification.class);
                    startActivity(i);
                } else if (position == 6) {
                    Toast.makeText(MyFollowers.this, "EmergencyContacts", Toast.LENGTH_LONG).show();
                } else if (position == 7) {
